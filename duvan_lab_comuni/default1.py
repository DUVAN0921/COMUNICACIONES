...
class default1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "default1")
        ...
        self._freq_range = Range(1000, 40000, 1000, 32000/12, 200)
...
def main(top_block_cls=default1, options=None):
